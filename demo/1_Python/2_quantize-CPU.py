...
Expected input directory layout (example: ./merged_qwen_python):
- config.json
...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description=(
            "Convert a merged Hugging Face model directory (for example ./merged_qwen_python) "
